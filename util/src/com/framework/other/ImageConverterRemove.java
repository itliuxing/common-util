...
/**
* @Class 	ImageConverterRemove.java
* @Author 	作者姓名:刘兴 
* @Version	1.0
* @Date		创建时间：2018年9月20日 下午2:29:02
* @Copyright Copyright by 刘兴
* @Direction 类说明		去除图片上线的logo
*/
public class ImageConverterRemove {
	...
	public static void main(String[] args) { 
       /* System.out.println("输入需要去水印的图片所在的根目录回车（支持递归子目录）："); 
        ...
        convertAllImages( "D:/image/source", "D:/image/target"); 
    ...
    public static void replaceImageColor(String file, String dstFile, Color srcColor, Color targetColor) throws IOException { 
        ...
        for (int i = 0; i < bi.getWidth(); i++) { 
            for (int j = 0; j < bi.getHeight(); j++) { 
                ...
                //粉色 
                if (greed < 190 || blue < 180) { 
  
                } else { 
                    if (red < 184 && red > 144 && greed > 190 && blue > 180) { 
